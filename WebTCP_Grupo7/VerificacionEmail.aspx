...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <p class="text-center mb-5">Ingrese el código que le llego a tu email:</p>
        ...
        <div class="row d-flex justify-content-center align-item-center p-4 mt-3 mb-5">
            <div class="col-md-6">
                ...
                <div class="row g-1">
                    <div class="col-md-12 fw-bold ">
                        <label for="txtCodigo" class="form-label w-bold">Ingresa el código</label>
                        <asp:TextBox runat="server" ClientIDMode="Static" ID="txtCodigo" class="form-control" placeholder="Código" />
            ...
            <div class="col-12 text-center mt-3 ">
                ...
                <asp:Button Text="Cancelar" CssClass="btn btn-secondary ms-2" ID="btnCancelar" OnClick="btnCancelar_Click" runat="server" />
            </div>
